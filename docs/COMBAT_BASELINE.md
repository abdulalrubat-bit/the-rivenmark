# Combat baseline — default controls
...
| C02 | A tap while the blade is still coming round is lost, not queued. | 2 taps (the second at half the 0.62s beat): 1 swing | yes |
...
| C06 | A cancelled gesture is treated as a release. | gathering 0.48, then pointercancel: logged "heavy" | yes |
